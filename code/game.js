...
Level.prototype.obstacleAt = function (pos, size) {
  ...
  // for possibe obstacles (non null value)
...
Gold.prototype.act = function(step) {
  this.wobble += step * goldSpeed;
  var goldPos = Math.sin(this.wobble) * goldDist;
  this.pos = this.basePos.plus(new Vector(0, goldPos));
};
...
Player.prototype.moveY = function(step, level, keys) {
  ...
  // if they are touhing some obstacles
  if (obstacle) {
